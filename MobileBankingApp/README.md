...
1. Open VS Code
2. Press `Ctrl+Shift+P` → type **"Tomcat: Add Tomcat Server"**
3. Browse to your Tomcat installation folder (e.g. `C:\tomcat9`)
4. Tomcat will appear in the **Tomcat Servers** panel (bottom left)
...
1. Package the project as a WAR:
   ```bash
   cd MobileBankingApp
...
3. Start Tomcat and access the app.
...
2. Start Tomcat (via VS Code or manually)
